...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.align-items-center.mb-5
      .col-lg-0.col-12.mb-5.mb-md-0(data-aos="fade-right")
        LineaTiempoD.color-acento-botones
          p(numero="1" titulo="Mejor economía") 
    ...
    .cajon.align-items-center.color-custom.p-4.mb-4
    ...
    .row.align-items-end.mb-4
      ...
      .col-lg-8(data-aos="fade-left")
        ...
        .cajon.color-custom.bg-9.p-4.mb-4
          p.mb-4 Para el proveedor el camino es crear grandes centros de datos dotados con todas las características y bondades de la computación en la nube a fin de poder entregar y ofrecer un gran volumen de clientes nuevos que hagan rentable la inversión.
      ...
      .col-sm-6.col-lg-3.mb-4.mb-lg-0
        .tarjeta--boton.bg10.color-primario.p-4
          .row.justify-content-center.mb-3
            .col-7
              figure
                img(src='@/assets/curso/temas/t2/icono02.svg', alt='Texto que describa la imagen')
          h3.text2.text-center Interrogante 2
          p.text-white.text-small ¿Qué nivel de soporte y respuesta a incidentes esperan por parte del proveedor?
      ...
      .col-sm-6.col-lg-3.mb-4.mb-lg-0
        .tarjeta--boton.bg10.color-primario.p-4
          .row.justify-content-center.mb-3
            .col-7
              figure
                img(src='@/assets/curso/temas/t2/icono03.svg', alt='Texto que describa la imagen')
          h3.text2.text-center Interrogante 3
          p.text-white.text-small ¿Cómo la organización puede validar la calidad en el servicio ofrecido por el proveedor?
    ...
    .row.align-items-end.mb-4
      ...
      .col-lg-8(data-aos="fade-left")
        ...
        .bg10.p-4
          h4.text2 Amenazas
          p.text-white.mb-4 El tipo de servicio contratado según los SLA previamente establecidos entre proveedor y cliente donde se determinan las responsabilidades de cada parte.
          p.text-white El tipo de despliegue o puesta en producción de los servicios contratados.
    
    p.mb-4 En términos generales son varias las amenazas que afectan la computación en la nube como podemos ver en el siguiente recurso educativo:
    ...
    .bg2.mb-4(data-aos="fade-down")
      SlyderA(tipo="b").p-4
        ...
        .row.justify-content-around
          ...
          .col-md-5
            img(src='@/assets/curso/temas/t2/imag09.svg', alt='')
        .row.justify-content-around
          .col-md-5
    ...
    .row.align-items-end.mb-4
      ...
      .col-lg-8(data-aos="fade-left")
        ...
        .cajon.color-custom.bg-9.p-4.mb-4
          p.mb-4 Los auditores externos o empresas contratadas generan informes de tipo SOC (Auditoría de los Controles de Servicio) el cual es un estándar internacional que permite evaluar los controles de seguridad de un proveedor y las amenazas de ciberseguridad.
      ...
      .col-sm-6.col-lg-3.mb-4.mb-lg-0
        .tarjeta--boton.color-primario.p-4
          .row.justify-content-center.mb-3
            .col-7
              figure
                img(src='@/assets/curso/temas/t2/icono04.svg', alt='Texto que describa la imagen')
          h3.text-center SOC 1
          p.text-small Que cubren los informes financieros. 
      .col-sm-6.col-lg-3.mb-4.mb-lg-0
        .tarjeta--boton.color-primario.p-4
          .row.justify-content-center.mb-3
            .col-7
              figure
                img(src='@/assets/curso/temas/t2/icono05.svg', alt='Texto que describa la imagen')
          h3.text-center SOC 2
          p.text-small Que cubren la seguridad, la disponibilidad y la privacidad.
      .col-sm-6.col-lg-3.mb-4.mb-lg-0
        .tarjeta--boton.color-primario.p-4
          .row.justify-content-center.mb-3
            .col-7
              figure
                img(src='@/assets/curso/temas/t2/icono06.svg', alt='Texto que describa la imagen')
          h3.text-center SOC 3
          p.text-small SQue también cubren la seguridad, la disponibilidad y la privacidad.
    
    .row.align-items-end.mb-4
      .col-lg-8(data-aos="fade-left")
        .cajon.color-custom.bg-9.p-4.mb-4
          p.mb-4 Normalmente estos informes son privados por lo menos SOC 1 y SOC 2 están disponibles solo para el cliente quien tiene contratado un acuerdo de nivel de servicio mientras que el SOC 3 está disponible para el público.
